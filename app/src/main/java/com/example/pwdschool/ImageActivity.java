...
public class ImageActivity extends AppCompatActivity {
    ...
    private final String Address = "http://192.168.1.2/appFetchSchoolBuildings.php?user=" + Login.selectedJuniorEngineer + "&school=" + DisplaySchool.selectedSchoolHistory;
